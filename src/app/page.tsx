        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center">
              <span className="text-2xl font-bold text-blue-600">CodeDoc Genie</span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link
  href="/signup"
  className="bg-blue-800 text-white font-bold px-5 py-2.5 rounded-lg hover:bg-blue-900 transition shadow-md hover:shadow-lg"
>
  <span className="text-white">Sign Up</span>
      ...
      <section className="container mx-auto px-6 flex flex-col justify-center items-center text-center min-h-[calc(100vh-80px)] pt-10 pb-20 md:pt-16 md:pb-24">
        <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6 leading-tight">
          Document Your Code Like <span className="text-blue-600">Magic</span>
        </h1>
        ...
        <Link
  href="/signup"
  className="bg-blue-800 text-white font-bold px-8 py-3.5 rounded-lg text-lg hover:bg-blue-900 transition w-full md:w-auto shadow-lg hover:shadow-xl transform hover:scale-105"
>
  <span className="text-white">Get Started — It's Free</span>
</Link>

          <Link href="/chat" className="border-2 border-blue-800 text-blue-800 bg-white font-bold px-8 py-3.5 rounded-lg text-lg hover:bg-blue-50 transition w-full md:w-auto shadow-md hover:shadow-lg transform hover:scale-105">
            Try Demo
          </Link>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-10 text-center">
            <div className="flex flex-col items-center bg-white p-8 rounded-xl shadow-lg">
              <div className="bg-blue-600 text-white rounded-full w-14 h-14 flex items-center justify-center mb-6 text-2xl font-bold">1</div>
              <h3 className="text-2xl font-semibold text-gray-800 mb-2">Paste Your Code</h3>
              <p className="text-gray-600">Simply paste your code or upload a file into our editor.</p>
            </div>
            
            <div className="flex flex-col items-center bg-white p-8 rounded-xl shadow-lg">
              <div className="bg-blue-600 text-white rounded-full w-14 h-14 flex items-center justify-center mb-6 text-2xl font-bold">2</div>
            ...
            <div className="flex flex-col items-center bg-white p-8 rounded-xl shadow-lg">
              <div className="bg-blue-600 text-white rounded-full w-14 h-14 flex items-center justify-center mb-6 text-2xl font-bold">3</div>
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden">
          <div className="md:flex">
            <div className="md:w-1/2 p-8 md:p-12">
              ...
              <Link
  href="/signup"
  className="inline-block bg-blue-800 font-bold px-8 py-3.5 rounded-lg hover:bg-blue-900 transition shadow-md hover:shadow-lg transform hover:scale-105"
>
  <span className="text-white !text-white">Join Our Community</span>
</Link>

            </div>
            <div className="md:w-1/2 bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center p-12">
